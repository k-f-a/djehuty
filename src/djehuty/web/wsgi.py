...
class WebServer:
    ...
    def __init__(self, address="127.0.0.1", port=8080):
        ...
        self.url_map = Map(
            [
                ...
                R(
                    "/my/datasets/<dataset_uuid>/private_link/<link_id>/delete",
                    self.ui_dataset_delete_private_link,
                ),
                ...
                R(
                    "/my/collections/<collection_uuid>/private_links",
                    self.ui_collection_private_links,
                ),
                R(
                    "/my/collections/<collection_uuid>/private_link/<link_id>/delete",
                    self.ui_collection_delete_private_link,
                ),
                R(
                    "/my/collections/<collection_uuid>/private_link/new",
                    self.ui_collection_new_private_link,
                ),
                R("/my/collections/new", self.ui_new_collection),
                R(
                    "/my/collections/<collection_id>/new-version-draft",
                    self.ui_new_version_draft_collection,
                ),
                ...
                R(
                    "/admin/approve-quota-request/<quota_request_uuid>",
                    self.ui_admin_approve_quota_request,
                ),
                R("/admin/dashboard", self.ui_admin_dashboard),
                R(
                    "/admin/deny-quota-request/<quota_request_uuid>",
                    self.ui_admin_deny_quota_request,
                ),
                ...
                R(
                    ...
                    self.ui_admin_repair_doi_registrations,
                ),
                R(
                    "/admin/maintenance/remove-website-sessions",
                    self.ui_admin_remove_website_sessions,
                ),
                R(
                    "/admin/maintenance/recalculate-statistics",
                    self.ui_admin_recalculate_statistics,
                ),
                ...
                R(
                    "/export/<citation_format>/<item_type>s/<item_id>/<version>",
                    self.ui_export_citation,
                ),
                ## SAML 2.0
                ## ----------------------------------------------------------------
                ...
                R(
                    "/v2/account/institution/users/<account_id>",
                    self.api_private_institution_account,
                ),
                ...
                R(
                    ...
                    self.api_dataset_version_embargo,
                ),
                R(
                    "/v2/articles/<dataset_id>/versions/<version>/confidentiality",
                    self.api_dataset_version_confidentiality,
                ),
                R(
                    "/v2/articles/<dataset_id>/versions/<version>/update_thumb",
                    self.api_dataset_version_update_thumb,
                ),
                ...
                R(
                    ...
                    self.api_private_dataset_author_delete,
                ),
                ...
                R(
                    ...
                    self.api_private_dataset_funding_delete,
                ),
                R(
                    "/v2/account/articles/<dataset_id>/categories",
                    self.api_private_dataset_categories,
                ),
                R(
                    "/v2/account/articles/<dataset_id>/categories/<category_id>",
                    self.api_private_delete_dataset_category,
                ),
                ...
                R(
                    ...
                    self.api_private_dataset_file_details,
                ),
                R(
                    "/v2/account/articles/<dataset_id>/private_links",
                    self.api_private_dataset_private_links,
                ),
                R(
                    "/v2/account/articles/<dataset_id>/private_links/<link_id>",
                    self.api_private_dataset_private_links_details,
                ),
                R(
                    "/v2/account/articles/<dataset_id>/reserve_doi",
                    self.api_private_dataset_reserve_doi,
                ),
                ...
                R(
                    ...
                    self.api_collection_version_details,
                ),
                ...
                R(
                    "/v3/datasets/<dataset_id>/update-thumbnail",
                    self.api_v3_datasets_update_thumbnail,
                ),
                ...
                R(
                    ...
                    self.api_v3_datasets_git_set_default_branch,
                ),
                R("/v3/file/<file_id>", self.api_v3_file),
                R("/v3/datasets/<container_uuid>/authors", self.api_v3_dataset_authors),
                R(
                    "/v3/datasets/<container_uuid>/authors/<author_uuid>",
                    self.api_v3_dataset_authors,
                ),
                R(
                    "/v3/datasets/<container_uuid>/reorder-authors",
                    self.api_v3_datasets_authors_reorder,
                ),
                R(
                    "/v3/collections/<container_uuid>/reorder-authors",
                    self.api_v3_collections_authors_reorder,
                ),
                ...
                R(
                    ...
                    self.api_v3_update_collaborators,
                ),
                ...
                R(
                    ...
                    self.api_v3_datasets_assign_reviewer,
                ),
                ...
                R(
                    ...
                    self.api_v3_admin_files_integrity_statistics,
                ),
                ...
                R(
                    ...
                    self.api_v3_private_dataset_git_upload_pack,
                ),
                R(
                    "/v3/datasets/<git_uuid>.git/git-receive-pack",
                    self.api_v3_private_dataset_git_receive_pack,
                ),
                ...
                ## ----------------------------------------------------------------
                R(
                    "/iiif/v3/<file_uuid>/<region>/<size>/<rotation>/<quality>.<image_format>",
                    self.iiif_v3_image,
                ),
                R("/iiif/v3/<file_uuid>", self.iiif_v3_image_context_redirect),
                R("/iiif/v3/<file_uuid>/info.json", self.iiif_v3_image_context),
                R(
                    "/iiif/v3/<container_uuid>/<version>/manifest",
                    self.iiif_v3_presentation_manifest,
                ),
        ...
        self.metadata_jinja = Environment(
            loader=FileSystemLoader(
                [
        ...
        try:
            ...
            if extension == "gif":
                ...
                resized_image = Image.new(
                    "RGBA", (first_frame_size[0] * len(frames), first_frame_size[1])
                )
    ...
    def __render_template(self, request, template_name, **context):
        ...
        return self.response(template.render({**context, **parameters}), mimetype="text/html")
    ...
    def __send_templated_email(self, email_addresses, subject, template_name, **context):
        ...
        for email_address in email_addresses:
            ...
            text, html = self.__render_email_templates(
    ...
    def __author_list_from_request_input(self, parameters, created_by=None):
        ...
        for record in records:
            ...
            if author_uuid is None:
                return None, [
                    {"field_name": "authors", "message": "Unable to create author record."}
                ]
            authors.append(URIRef(uuid_to_uri(author_uuid, "author")))
    ...
    def __funding_list_from_request_input(self, parameters, created_by=None):
        ...
        for record in records:
            ...
            if funder_uuid and not validator.is_valid_uuid(funder_uuid):
                return None, [
                    {"field_name": "funding_list.uuid", "message": "Invalid UUID for funder."}
                ]
    ...
    def create_static_error_pages(self):
        ...
        try:
            ...
            shutil.copytree(
                os.path.join(resources_path, "resources", "static"),
            ...
            for page in ["500", "502"]:
                with open(os.path.join(base_dir, f"{page}.html"), "wb") as stream:
                    response = self.__render_template(
                        Request({}), f"{page}.html", email=config.support_email_address
                    )
    ...
    def error_400(self, request, message, code):
        ...
        return self.error_400_list(request, {"message": message, "code": code})
    ...
    def error_404(self, request, audit_log_message=None):
        ...
        if self.accepts_html(request, strict=True):
            ...
            response = self.response(json.dumps({"message": "This resource does not exist."}))
        response.status_code = 404
        return response

    def error_405(self, allowed_methods):
        """Procedure to respond with HTTP 405."""
        response = self.response(f"Acceptable methods: {allowed_methods}", mimetype="text/plain")
        response.status_code = 405
        return response

    def error_409(self):
        """Procedure to respond with HTTP 409."""
        response = self.response(json.dumps({"message": "The resource is already available."}))
    ...
    def error_410(self, request):
        ...
        if self.accepts_html(request, strict=True):
            ...
            response = self.response(json.dumps({"message": "This resource is gone."}))
    ...
    def error_415(self, allowed_types):
        ...
        response = self.response(f"Supported Content-Types: {allowed_types}", mimetype="text/plain")
        response.status_code = 415
        return response

    def error_406(self, allowed_formats):
        """Procedure to respond with HTTP 406."""
        response = self.response(f"Acceptable formats: {allowed_formats}", mimetype="text/plain")
    ...
    def default_error_handling(self, request, methods, content_type):
        ...
        if request.method not in methods and (not ("GET" in methods and request.method == "HEAD")):
    ...
    def default_authenticated_error_handling(
        self, request, methods, content_type, privilege_test=None
    ):
    ...
    def __dataset_by_id_or_uri(
        ...
        try:
            ...
            if parses_to_int(identifier):
                dataset = self.db.datasets(dataset_id=int(identifier), **parameters)[0]
            elif validator.is_valid_uuid(identifier):
                dataset = self.db.datasets(container_uuid=identifier, **parameters)[0]
    ...
    def __collection_by_id_or_uri(
        ...
        try:
            ...
            collection = None
            if parses_to_int(identifier):
                collection = self.db.collections(collection_id=int(identifier), **parameters)[0]
            elif validator.is_valid_uuid(identifier):
                collection = self.db.collections(container_uuid=identifier, **parameters)[0]
    ...
    def __files_by_id_or_uri(
        self, identifier=None, account_uuid=None, dataset_uri=None, private_view=False
    ):
        try:
            parameters = {
            ...
            elif validator.is_valid_uuid(identifier) and validator.is_valid_uuid(
                uri_to_uuid(dataset_uri)
            ):
    ...
    def __needs_collaborative_permissions(
        self, account_uuid, request, item_type, item, permissions
    ):
        ...
        if "uuid" not in item:
            return None, self.error_403(
                request, f"Missing 'uuid' in item for account:{account_uuid}."
            )
        ...
        if not permissions:
            return None, self.error_403(
                request,
                (f"Could not find permissions for account:{account_uuid} on {item['uuid']}."),
            )
        ...
        for permission in permissions:
            if not value_or(record, permission, False):
                return None, self.error_403(
                    request,
                    (
                        f"account:{account_uuid} attempted action "
    ...
    def __file_by_id_or_uri(
        self, identifier, account_uuid=None, dataset_uri=None, private_view=False
    ):
        try:
            return self.__files_by_id_or_uri(identifier, account_uuid, dataset_uri, private_view)[0]
    ...
    def __default_dataset_api_parameters(self, request):
        ...
        record = {
            "categories": validator.string_value(
                self.get_parameter(request, "categories"), None, maximum_length=512
            ),
            "doi": validator.string_value(
                self.get_parameter(request, "doi"), None, maximum_length=255
            ),
            "groups": validator.integer_value(self.get_parameter(request, "group"), None),
            "handle": validator.string_value(
                self.get_parameter(request, "handle"), None, maximum_length=255
            ),
            "institution": validator.integer_value(
                self.get_parameter(request, "institution"), None
            ),
            ...
            "modified_since": validator.string_value(
                self.get_parameter(request, "modified_since"), None, maximum_length=32
            ),
            "order": validator.string_value(
                self.get_parameter(request, "order"), None, maximum_length=32
            ),
            "order_direction": validator.order_direction(
                self.get_parameter(request, "order_direction"), None
            ),
            "published_since": validator.string_value(
                self.get_parameter(request, "published_since"), None, maximum_length=32
            ),
            "resource_doi": validator.string_value(
                self.get_parameter(request, "resource_doi"), None, maximum_length=255
            ),
            "search_for": self.parse_search_terms(self.get_parameter(request, "search_for")),
            "search_format": validator.boolean_value(
                self.get_parameter(request, "search_format"), None
            ),
        }
    ...
    def __groups_for_account(self, account):
        ...
        try:
            ...
            if "group_id" in account:
                ...
                groups = self.db.group(parent_id=28585, order_direction="asc", order="id")

                for index, _ in enumerate(groups):
                    groups[index]["subgroups"] = self.db.group(
                        parent_id=groups[index]["id"], order_direction="asc", order="id"
                    )
    ...
    def log_access_using_x_forwarded_for(self, request):
        ...
        try:
            self.log.access(
                "%s requested %s %s.",  # pylint: disable=no-member
    ...
    def obtain_orcid_read_public_token(self):
        ...
        response = requests.post(
            f"{config.orcid_endpoint}/token", params=url_parameters, headers=headers, timeout=10
        )

        if response.status_code != 200:
            self.log.error(
                "Failed to obtain read-public token from ORCID (%d).", response.status_code
            )
            return False
    ...
    def saml_metadata(self, request):
        ...
        if not (
            self.accepts_content_type(request, "application/samlmetadata+xml", strict=False)
            or self.accepts_xml(request)
        ):
    ...
    def accepts_plain_text(self, request):
        ...
        return self.accepts_content_type(request, "text/plain") or self.accepts_content_type(
            request, "*/*"
        )

    def accepts_xml(self, request):
        """Procedure to check whether the client accepts XML."""
        return self.accepts_content_type(request, "application/xml") or self.accepts_content_type(
            request, "text/xml"
        )
        ...
        try:
            if account["may_impersonate"]:
                ...
                if impersonate is not None:
                    impersonated_account = self.db.accounts(id_lte=impersonate, id_gte=impersonate)[
                        0
                    ]
                    impersonate = impersonated_account["uuid"]
                    self.log.access(
                        "Account %s impersonating account %s.",  #  pylint: disable=no-member
                        account["uuid"],
                        impersonate,
                    )
                    return impersonate
    ...
    def __account_uuid_for_privilege(self, request, privilege_test):
        ...
        token = self.token_from_request(request)
        if not privilege_test(token):
            error_response = self.error_403(
                request,
                (f"account:{account_uuid} didn't pass privilege test '{privilege_test.__name__}'."),
            )
    ...
    def loader_svg(self, request):
        ...
        return self.__render_svg_template(
            "loader.svg", primary_color=config.colors["primary-color"]
        )
    ...
    def sitemap(self, request):
        ...
        datasets = self.db.datasets(is_published=True, is_latest=True, limit=50000)
        return self.__render_xml_template(
            "sitemap_template.xml", base_url=config.base_url, datasets=datasets
        )
    ...
    def ui_account_home(self, request):
        ...
        if config.identity_provider == "orcid":
            return redirect(
                (
                    f"{config.orcid_endpoint}/authorize?client_id="
    ...
    def __send_sram_collaboration_invite(self, saml_record):
        ...
        if (
            config.sram_organization_api_token is None
            or config.sram_collaboration_id is None
            or "email" not in saml_record
        ):
            return None
        ...
        if response.status_code == 201:
            self.log.info(
                "Sent invite to '%s' for SRAM collaboration membership.", saml_record["email"]
            )
    ...
    def __already_in_sram_collaboration(self, saml_record):
        ...
        response = requests.get(
            f"https://sram.surf.nl/api/collaborations/v1/{config.sram_collaboration_id}",
            headers=headers,
            timeout=60,
        )
        if response.status_code != 200:
            self.log.error(
                "Retrieving SRAM collaboration members failed with status code %s",
        ...
        try:
            ...
            for member in memberships:
                ...
                if saml_record["email"].lower() == member["user"]["email"].lower():
                    self.log.info(
                        "Account '%s' is already part of an SRAM collaboration.",
                        saml_record["email"],
                    )
                    return True
    ...
    def ui_login(self, request):
        ...
        ## --------------------------------------------------------------------
            ...
            if account_uuid is None:
                try:
                    ...
                    if not account_uuid:
                        return self.error_403(
                            request, (f"Failed to create account for {orcid_record['orcid']}.")
                        )
                ...
                try:
                    ...
                    if account:
                        ...
                        if not self.db.update_account(account_uuid, domain=saml_record["domain"]):
                            ...
                            self.log.info(
                                "Updated domain to '%s' for account:%s.",
                                saml_record["domain"],
                                account_uuid,
                            )
                            ...
                            for dataset in datasets:
                                if "group_name" not in dataset:
                                    self.db.associate_dataset_with_group(
                                        dataset["uri"], saml_record["domain"], account_uuid
                                    )

                            # The supervisor privileges are defined in the XML configuration.
                            if value_or_none(
                                saml_record, "group_uuid"
                            ) is not None and self.db.insert_group_member(
                                saml_record["group_uuid"], account_uuid, False
                            ):
                                self.log.info(
                                    "Added account:%s to group group:%s.",
                                    account_uuid,
                                    saml_record["group_uuid"],
                                )
                            else:
                                self.log.info(
                                    "Failed to add account:%s to group group:%s.",
                                    account_uuid,
                                    value_or_none(saml_record, "group_uuid"),
                                )
                        ...
                        if account_uuid is None:
                            return self.error_500(
                                f"Creating account for {saml_record['email']} failed."
                            )
                        self.log.access("Account %s created via SAML.", account_uuid)  #  pylint: disable=no-member

                    if (
                        config.sram_collaboration_id is not None
                        and config.sram_organization_api_token is not None
                    ):
                        try:
                            ...
                            self.log.warning(
                                "An error (%s) occurred when sending invite to %s.",
                                error,
                                value_or_none(saml_record, "email"),
                            )
                        except requests.exceptions.ConnectionError:
                            self.log.error(
                                "Failed to send invite through SRAM due to a connection error."
                            )
                    ...
                    if not value_or(authors, 0, True):
                        ...
                        self.log.info(
                            "Created author record %s for account %s.", author_uuid, account_uuid
                        )
        ...
        if account_uuid is not None:
            token, mfa_token, session_uuid = self.db.insert_session(
                account_uuid, name="Website login"
            )
    ...
    def ui_logout(self, request):
        ...
        if other_session_token:
            ...
            response.set_cookie(
                key=self.cookie_key, value=other_session_token, secure=config.in_production
            )
    ...
    def ui_review_impersonate_to_dataset(self, request, dataset_id):
        ...
        account_uuid = self.default_authenticated_error_handling(
            request, "GET", "text/html", self.db.may_impersonate
        )
        ...
        dataset = None
        try:
            dataset = self.db.datasets(
                dataset_uuid=dataset_id, is_published=False, is_under_review=True
            )[0]
        ...
        if dataset is None:
            return self.error_403(
                request,
                (f"account:{account_uuid} attempted impersonation on dataset:{dataset_id}."),
            )
        ...
        response.set_cookie(
            key=self.impersonator_cookie_key,
            value=self.token_from_request(request),
            secure=config.in_production,
        )
        response.set_cookie(
            key="redirect_to", value="/review/overview", secure=config.in_production
        )

        # Create a new session for the user to be impersonated as.
        new_token, _, _ = self.db.insert_session(
            dataset["account_uuid"], name="Reviewer", override_mfa=True
        )
        response.set_cookie(key=self.cookie_key, value=new_token, secure=config.in_production)
        return response
    ...
    def ui_admin_impersonate(self, request, account_uuid):
        ...
        response = redirect("/my/dashboard", code=302)
        response.set_cookie(
            key=self.impersonator_cookie_key, value=token, secure=config.in_production
        )
        response.set_cookie(key="redirect_to", value="/admin/users", secure=config.in_production)

        # Create a new session for the user to be impersonated as.
        new_token, _, _ = self.db.insert_session(
            account_uuid, name="Impersonation", override_mfa=True
        )
        response.set_cookie(key=self.cookie_key, value=new_token, secure=config.in_production)
        return response
    ...
    def ui_dashboard(self, request):
        ...
        pending_quota_requests = self.db.quota_requests(
            status="unresolved", account_uuid=account_uuid
        )
    ...
    def ui_my_data(self, request):
        ...
        draft_datasets = self.db.datasets(
            account_uuid=account_uuid, limit=10000, is_published=False, is_under_review=False
        )
        review_datasets = self.db.datasets(
            account_uuid=account_uuid, limit=10000, is_published=False, is_under_review=True
        )
        published_datasets = self.db.datasets(
            account_uuid=account_uuid, limit=10000, is_latest=True, is_under_review=False
        )
    ...
    def ui_collection_published(self, request, collection_id):
        ...
        return self.__render_template(
            request, "depositor/published-collection.html", collection_id=collection_id
        )
    ...
    def ui_new_dataset(self, request):
        ...
        account = self.db.account_by_uuid(account_uuid)
        container_uuid, dataset_uuid = self.db.insert_dataset(
            title="Untitled item",
            account_uuid=account_uuid,
        ...
        if container_uuid is not None and dataset_uuid is not None:
            ...
            try:
                ...
                self.db.update_item_list(dataset_uuid, account_uuid, [author_uri], "authors")
            except (TypeError, KeyError):
    ...
    def ui_new_version_draft_dataset(self, request, dataset_id):
        ...
        dataset = self.__dataset_by_id_or_uri(
            dataset_id, is_published=True, account_uuid=account_uuid
        )
        ...
        if dataset is None or container_uuid is None:
            return self.error_403(
                request,
                (
                    f"account:{account_uuid} attempted to create "
                    f"new version of dataset:{dataset_id}."
                ),
            )

        existing_draft = self.__dataset_by_id_or_uri(
            container_uuid, is_published=False, account_uuid=account_uuid, use_cache=False
        )
        if existing_draft is not None:
            self.log.info("Refusing to create two drafts for one dataset.")
            return redirect(f"/my/datasets/{container_uuid}/edit", code=302)

        draft_uuid = self.db.create_draft_from_published_dataset(
            container_uuid, account_uuid=account_uuid
        )
    ...
    def ui_edit_dataset(self, request, dataset_id):
        ...
        try:
            dataset = self.__dataset_by_id_or_uri(
                dataset_id, is_published=False, account_uuid=account_uuid, use_cache=False
            )

            if dataset is None:
                return self.error_403(
                    request, (f"account:{account_uuid} attempted to access dataset:{dataset_id}.")
                )
            ...
            dataset["doi"] = self.__standard_doi(
    ...
    def ui_delete_dataset(self, request, dataset_id):
        ...
        try:
            dataset = self.__dataset_by_id_or_uri(
                dataset_id, account_uuid=account_uuid, is_published=False
            )

            if dataset is None:
                return self.error_403(
                    request, (f"account:{account_uuid} attempted to delete dataset:{dataset_id}.")
                )

            container_uuid = dataset["container_uuid"]
            if self.db.delete_dataset_draft(
                container_uuid, dataset["uuid"], account_uuid, dataset["account_uuid"]
            ):
    ...
    def ui_dataset_private_links(self, request, dataset_uuid):
        ...
        try:
            ...
            return self.error_403(
                request,
                (
                    f"account:{account_uuid} attempted "
        ...
        links = self.db.private_links(item_uri=dataset["uri"], account_uuid=account_uuid)
    ...
    def ui_collection_private_links(self, request, collection_uuid):
        ...
        links = self.db.private_links(item_uri=collection["uri"], account_uuid=account_uuid)
    ...
    def ui_my_collections(self, request):
        ...
        drafts = self.db.collections(account_uuid=account_uuid, is_published=False, limit=10000)

        for collection in drafts:
            count = self.db.collections_dataset_count(collection["uri"])
            collection["number_of_datasets"] = count

        published = self.db.collections(
            account_uuid=account_uuid, is_published=True, is_latest=True, limit=10000
        )
    ...
    def ui_edit_collection(self, request, collection_id):
        ...
        try:
            ...
            if collection is None:
                return self.error_403(
                    request,
                    (f"account:{account_uuid} attempted to edit collection:{collection_id}."),
                )

            categories = self.db.categories_tree()
            account = self.db.account_by_uuid(account_uuid)
            groups = self.__groups_for_account(account)
            collection["doi"] = self.__standard_doi(
                collection["container_uuid"],
                version=None,
    ...
    def ui_new_collection(self, request):
        ...
        container_uuid, collection_uuid = self.db.insert_collection(
            title="Untitled collection", account_uuid=account_uuid
        )
        ...
        if container_uuid is not None and collection_uuid is not None:
            ...
            try:
                account = self.db.account_by_uuid(account_uuid)
                author_uri = URIRef(uuid_to_uri(account["author_uuid"], "author"))
                self.db.update_item_list(collection_uuid, account_uuid, [author_uri], "authors")
            except (TypeError, KeyError):
                self.log.warning("No author record for account %s.", account_uuid)
    ...
    def ui_new_version_draft_collection(self, request, collection_id):
        ...
        existing_draft = self.__collection_by_id_or_uri(
            collection_id, is_published=False, account_uuid=account_uuid, use_cache=False
        )
        if existing_draft is not None:
    ...
    def ui_delete_collection(self, request, collection_id):
        ...
        try:
            ...
            if collection is None:
                return self.error_403(
                    request,
                    (f"account:{account_uuid} attempted to delete collection:{collection_id}."),
                )

            result = self.db.delete_collection_draft(
                container_uuid=collection["container_uuid"], account_uuid=account_uuid
            )
                ...
                try:
                    ...
                    if not session["editable"]:
                        return self.error_403(
                            request,
                            (
                                f"account:{account_uuid} attempted to "
                                f"edit non-editable session:{session_uuid}."
                            ),
                        )

                    return self.__render_template(
                        request, "depositor/edit-session.html", session=session
                    )
                except IndexError:
                    return self.error_403(
                        request,
                        (
                            f"account:{account_uuid} attempted to edit "
    ...
    def ui_new_session(self, request):
        ...
        _, _, session_uuid = self.db.insert_session(
            account_uuid, name="Untitled", editable=True, override_mfa=True
        )
    ...
    def __remove_session_due_to_2fa_mismatch(self, session_uuid):
        ...
        if self.db.delete_inactive_session_by_uuid(session_uuid):
            self.log.access(
                "Removed session %s due to 2FA mismatch.",  #  pylint: disable=no-member
                session_uuid,
            )
        else:
    ...
    def ui_activate_session(self, request, session_uuid):
        ...
        if request.method == "GET":
            return self.__render_template(
                request, "activate_2fa_session.html", session_uuid=session_uuid
            )
        ...
        if request.method == "POST":
            ...
            if not parses_to_int(mfa_token):
                ...
                return self.error_403(
                    request, (f"session:{session_uuid} invalidated due to wrong MFA.")
                )
            ...
            session = self.db.sessions(
                account["uuid"], session_uuid=session_uuid, mfa_token=mfa_token
            )
    ...
    def api_v3_dataset_collaborators(self, request, dataset_uuid):
        ...
        dataset = self.__dataset_by_id_or_uri(
            dataset_uuid, account_uuid=account_uuid, is_published=None, is_latest=None
        )
        if not dataset:
            return self.error_403(request)
        ...
        if request.method == "POST":
            if value_or(dataset, "is_shared_with_me", False):
                return self.error_403(
                    request, (f"account:{account_uuid} attempted to modify dataset:{dataset_uuid}.")
                )
            ...
            collaborators = self.db.insert_collaborator(
                dataset["uuid"],
    ...
    def api_v3_update_collaborators(self, request, dataset_uuid, collaborator_uuid):
        ...
        account_uuid = self.default_authenticated_error_handling(
            request, ["PUT", "DELETE"], "application/json"
        )
        if isinstance(account_uuid, Response):
            return account_uuid

        if not validator.is_valid_uuid(dataset_uuid) or not validator.is_valid_uuid(
            collaborator_uuid
        ):
            return self.error_404(request)
        try:
            dataset = self.__dataset_by_id_or_uri(
                dataset_uuid, account_uuid=account_uuid, is_published=False, is_latest=None
            )
            ...
            for collaborator in collaborators:
                if (
                    collaborator["account_uuid"] == account_uuid
                    and not collaborator["is_supervisor"]
                ):
                    return self.error_403(
                        request,
                        (
            ...
            return self.error_403(
                request,
                (
                    f"account:{account_uuid} attempted to modify "
        ...
        if request.method == "PUT":
            ...
            metadata = parameters["metadata"]
            data = parameters["data"]
            if not self.db.update_collaborator(
                dataset["uuid"],
                collaborator_uuid,
                metadata["read"],
                metadata["edit"],
    ...
    def api_v3_accounts_search(self, request):
        ...
        try:
            ...
            search_for = validator.string_value(
                parameters, "search_for", 0, 32, required=True, strip_html=False
            )
    ...
    def ui_dataset_new_private_link(self, request, dataset_uuid):
        ...
        if request.method in ("GET", "HEAD"):
            return self.__render_template(
                request, "depositor/new_private_link.html", dataset_uuid=dataset_uuid
            )
        ...
        if request.method == "POST":
            try:
                ...
                expires_date = validator.options_value(
                    request.form, "expires_date", options, required=True
                )
                delta = None
    ...
    def __delete_private_link(self, request, item, account_uuid, private_link_id):
        ...
        self.locks.lock(locks.LockTypes.PRIVATE_LINKS)
        if (
            self.db.delete_private_links(item["container_uuid"], account_uuid, private_link_id)
            is None
        ):
            self.locks.unlock(locks.LockTypes.PRIVATE_LINKS)
            return self.error_500()
    ...
    def ui_profile_connect_with_orcid(self, request):
        ...
        if self.get_parameter(request, "code") is None:
            return redirect(
                (
                    ...
                    f"{config.orcid_client_id}&response_type=code"
                    "&scope=/authenticate&redirect_uri="
                    f"{config.base_url}/my/profile/connect-with-orcid"
                ),
                302,
            )
        ...
        orcid_record = self.authenticate_using_orcid(
            request, redirect_path="/my/profile/connect-with-orcid"
        )
        ...
        if orcid is None or account_uuid is None:
            return self.error_403(
                request, (f"account:{account_uuid} failed to authenticate ORCID.")
            )
        ...
        if not value_or(authors, 0, True):
            ...
            self.log.info("Created author record %s for account %s.", author_uuid, account_uuid)
    ...
    def ui_review_overview(self, request):
        ...
        return self.__render_template(
            request, "review/overview.html", reviewers=reviewers, reviews=reviews
        )
    ...
    def ui_review_published(self, request, dataset_id):
        ...
        return self.__render_template(
            request, "review/published.html", container_uuid=dataset["container_uuid"]
        )
    ...
    def __process_quota_request(self, request, quota_request_uuid, status):
        ...
        if not validator.is_valid_uuid(quota_request_uuid):
            return self.error_400(
                request, "Invalid quota request UUID.", "InvalidQuotaRequestUUIError"
            )
        ...
        if self.db.update_quota_request(quota_request_uuid, status=status):
            if status == "approved":
                try:
                    ...
                    self.log.error(
                        "Unable to send e-mail for quota request %s.", quota_request_uuid
                    )
    ...
    def ui_admin_quota_requests(self, request):
        ...
        return self.__render_template(
            request, "admin/quota_requests.html", quota_requests=quota_requests
        )
    ...
    def ui_admin_dashboard(self, request):
        ...
        return self.__render_template(
            request, "admin/dashboard.html", missing_dois=len(missing_doi_items)
        )
    ...
    def ui_admin_users(self, request):
        ...
        return self.__render_template(request, "admin/users.html", accounts=accounts)
    ...
    def ui_admin_reports_restricted_datasets(self, request):
        ...
        restricted_datasets = self.db.datasets(
            is_restricted=True, limit=10000, is_latest=True, use_cache=False
        )
        ...
        if export and fileformat:
            return self.__export_report_in_format(
                request, "restricted_datasets", restricted_datasets, fileformat
            )

        return self.__render_template(
            request, "admin/reports/restricted_datasets.html", datasets=restricted_datasets
        )
    ...
    def ui_admin_reports_embargoed_datasets(self, request):
        ...
        embargoed_datasets = self.db.datasets(
            is_embargoed=True, limit=10000, is_latest=True, use_cache=False
        )
        ...
        if export and fileformat:
            return self.__export_report_in_format(
                request, "embargoed_datasets", embargoed_datasets, fileformat
            )

        return self.__render_template(
            request, "admin/reports/embargoed_datasets.html", datasets=embargoed_datasets
        )
        ...
        if items:
            ...
            for item in items:
                if not self.__update_item_doi(
                    ...
                    error_count += 1
                    self.log.error(
                        "Registering DOI for publication of %s failed.", item["container_uuid"]
                    )
                    continue

                doi = self.__standard_doi(item["container_uuid"], version=item["version"])
                if not self.db.update_doi_after_publishing(item["uuid"], item["item_type"], doi):
                    self.log.error(
                        "Updating the DOI '%s' in the database failed for %s.", doi, item["uuid"]
                    )
    ...
    def ui_feedback(self, request):
        ...
        if request.method == "POST":
            ...
            try:
                ...
                email = self.__email_from_request(request)
                return self.__render_template(
                    request, "feedback.html", email=email, error_message=error.message
                )
        ...
        try:
            ...
            for rec in records:
                authors = self.db.authors(
                    item_uri=rec["dataset_uri"], item_type="dataset", limit=None
                )
    ...
    def ui_categories(self, request, category_id):
        ...
        datasets = self.db.datasets(categories=[category["id"]], limit=limit, offset=offset)
    ...
    def ui_private_dataset(self, request, private_link_id):
        ...
        try:
            dataset = self.db.datasets(
                private_link_id_string=private_link_id,
                is_published=None,
                is_latest=None,
                use_cache=False,
            )[0]
    ...
    def ui_private_collection(self, request, private_link_id):
        ...
        try:
            collection = self.db.collections(
                private_link_id_string=private_link_id, is_published=None, is_latest=None
            )[0]
            if value_or(collection, "private_link_is_expired", False):
                return self.__render_template(request, "private_link_is_expired.html")

            self.__log_event(request, collection["container_uuid"], "collection", "view")
            return self.ui_collection(
                request, collection["container_uuid"], collection=collection, private_view=True
            )
        except IndexError:
            pass
    ...
    def ui_dataset(
        self, request, dataset_id, version=None, dataset=None, private_view=False, anonymize=False
    ):
        ...
        if dataset is None:
            if version is not None:
                dataset = self.__dataset_by_id_or_uri(
                    dataset_id, is_published=True, version=version
                )
            else:
                dataset = self.__dataset_by_id_or_uri(dataset_id, is_published=True, is_latest=True)
        ...
        if value_or(dataset, "is_public", False) and not (
            value_or(dataset, "is_restricted", False) or value_or(dataset, "is_embargoed", False)
        ):
    ...
    def ui_data_access_request(self, request):
        ...
        try:
            ...
            reason = validator.string_value(
                parameters, "reason", 0, 10000, required=True, strip_html=False
            )

            dataset = self.db.datasets(container_uuid=dataset_id, version=version)[0]

            if not value_or_none(dataset, "is_confidential") and not (
                not value_or_none(dataset, "embargo_until_date")
                and value_or_none(dataset, "embargo_type")
            ):
                return self.error_403(
                    request,
                    (
                        f"{email} attempted to request "
    ...
    def ui_collection(
        self, request, collection_id, version=None, collection=None, private_view=False
    ):
        ...
        if collection is None:
            if version is not None:
                collection = self.__collection_by_id_or_uri(
                    collection_id, is_published=True, version=version
                )
            else:
                collection = self.__collection_by_id_or_uri(
                    collection_id, is_published=True, is_latest=True
                )

        # For retracted collections we display a different error page.
        if collection is None:
            collection = self.__collection_by_id_or_uri(
                collection_id, is_published=None, is_latest=None
            )
        ...
        statistics = {
            "downloads": value_or(collection, "total_downloads", 0),
        ...
        citation = make_citation(
            authors,
            posted_date,
            value_or(collection, "title", "Untitled"),
    ...
    def ui_author(self, request, author_uuid):
        ...
        try:
            ...
            statistics = {
                metric: sum(value_or(dataset, metric, 0) for dataset in datasets)
    ...
    def ui_institution(self, request, institution_name):
        ...
        datasets = self.db.datasets(groups=sub_group_ids, is_published=True, limit=100)

        return self.__render_template(
            request, "institutions.html", articles=datasets, group=group, sub_groups=sub_groups
        )
    ...
    def ui_category(self, request):
        ...
        return self.__render_template(request, "category.html", categories=categories)
    ...
    def ui_opendap_to_doi(self, request):
        ...
        if self.accepts_html(request):
            ...
            if not dois:
                ...
                catalog_start = [
                    f"https://opendap.4tu.nl/thredds/{'/'.join(catalog_parts[:-1])}/",
            ...
            return self.__render_template(
                request, "opendap_to_doi.html", dois=dois, referrer=referrer
            )
    ...
    def __filesystem_location(self, file_info):
            ...
            for location in config.storage_locations:
                if "filename" in file_info:
                    ...
                    if value_or(location, "quirks", False):
                        file_path = self.__quirky_filename(
        ...
        ## Files deposited pre-Djehuty have a numeric identifier (id)
            ...
            if config.secondary_storage_quirks:
                filename = self.__quirky_filename(
    ...
    def __accessible_files_for_dataset(self, request, dataset_id, file_id=None, version=None):
        ...
        if dataset is not None:
            if file_id is None:
                ...
                metadata = self.__files_by_id_or_uri(dataset_uri=dataset["uri"], private_view=True)
            else:
        ...
        # Published datasets
        dataset = self.__dataset_by_id_or_uri(
            dataset_id, is_published=True, version=version, use_cache=False
        )
        if dataset is not None:
            ...
            if is_embargoed or is_restricted:
                ...
                if value_or_none(dataset, "account_uuid") == account_uuid:
                    if file_id is None:
                        ...
                        metadata = self.__files_by_id_or_uri(
    ...
    def ui_download_file(self, request, dataset_id, file_id):
        ...
        if dataset is None or metadata is None:
            return self.error_403(
                request, (f"Denied access to file:{file_id} in dataset:{dataset_id}.")
            )

        if "container_uuid" not in dataset or "container_uuid" not in metadata:
            return self.error_403(
                request, (f"Missing container UUID for dataset:{dataset_id} or file:{file_id}.")
            )
        ...
        if dataset["container_uuid"] != metadata["container_uuid"]:
            return self.error_403(
                request,
                (
                    "Found a mismatch between container UUID "
        ...
        try:
            ...
            return self.error_403(
                request, (f"Back-end has no permission to access file {file_path}.")
            )
    ...
    def ui_download_all_files(self, request, dataset_id, version):
        ...
        dataset, metadata = self.__accessible_files_for_dataset(
            request, dataset_id, version=version
        )
        if dataset is None or metadata is None:
            return self.error_403(request)
        ...
        try:
            ...
            for file_info in metadata:
                if value_or(file_info, "is_link_only", False):
                    self.log.info("Skipping link-only file:%s for download.", file_info["uuid"])
                    continue
                file_path = self.__filesystem_location(file_info)
                if file_path is None:
                    self.log.error(
                        "Excluding missing file %s in ZIP of %s.", file_info["name"], dataset_id
                    )
                    continue
            ...
            if not file_paths:
                return self.error_404(
                    request,
                    (
                        f"Download-all for {dataset_id} failed: "
            ...
            if error_type == "HTTPError":
                self.log.error(
                    "Files download for %s failed due to S3 streaming error.", dataset_id
                )
            else:
                self.log.error("Files download for %s failed due to: %s", dataset_id, error)
    ...
    def api_private_institution_accounts(self, request):
        ...
        handler = self.default_authenticated_error_handling(
            request, "GET", "application/json", self.db.may_administer
        )
        ...
        try:
            ...
            institution_user_id = validator.string_value(
                request.args, "institution_user_id", 0, 4096
            )
    ...
    def api_private_institution_account(self, request, account_id):
        ...
        if not parses_to_int(account_id) and not validator.is_valid_uuid(account_uuid):
            return self.error_400(
                request, "'id' must be either an integer or a UUID.", "InvalidAccountId"
            )
    ...
    def api_datasets(self, request):
        ...
        try:
            ...
            return self.default_list_response(
                records, formatter.format_dataset_record, base_url=config.base_url
            )
    ...
    def api_datasets_search(self, request):
        ...
        try:
            ...
            output = self.default_list_response(
                records, formatter.format_dataset_record, base_url=config.base_url
            )
    ...
    def api_dataset_versions(self, request, dataset_id):
        ...
        return self.default_list_response(
            versions, formatter.format_dataset_version_record, base_url=config.base_url
        )
    ...
    def api_dataset_version_embargo(self, request, dataset_id, version):
        ...
        dataset = self.__dataset_by_id_or_uri(dataset_id, version=version, is_published=True)
        if dataset is None:
            return self.error_404(request)
    ...
    def api_dataset_version_update_thumb(self, request, dataset_id, version):
        ...
        metadata = self.__file_by_id_or_uri(
            file_id, dataset_uri=dataset["uri"], account_uuid=account_uuid
        )
        if metadata is None:
            return self.error_404(request)
    ...
    def api_dataset_files(self, request, dataset_id):
        ...
        return self.default_list_response(
            files, formatter.format_file_for_dataset_record, base_url=config.base_url
        )
    ...
    def api_dataset_file_details(self, request, dataset_id, file_id):
        ...
        try:
            ...
            response = self.response(json.dumps({"message": "This file cannot be found."}))
            response.status_code = 404
            return response
    ...
    def api_private_datasets(self, request):
        ...
        account_uuid = self.default_authenticated_error_handling(
            request, ["GET", "POST"], "application/json"
        )
        if isinstance(account_uuid, Response):
            return account_uuid
        ...
        if request.method in ("GET", "HEAD"):
            try:
                ...
                records = self.db.datasets(
                    limit=limit, offset=offset, is_published=False, account_uuid=account_uuid
                )
            ...
            try:
                ...
                container_uuid, _ = self.db.insert_dataset(
                    ...
                    description=validator.string_value(
                        record, "description", 0, 10000, False, strip_html=False
                    ),
                    tags=tags,
                    references=references,
                    categories=categories,
                    ...
                    defined_type_name=validator.options_value(
                        record, "defined_type", validator.dataset_types, False
                    ),
                    ...
                    publisher_publication=validator.string_value(
                        timeline, "publisherPublication", False
                    ),
    ...
    def api_private_dataset_details(self, request, dataset_id):
        ...
        account_uuid = self.default_authenticated_error_handling(
            request, ["GET", "PUT", "DELETE"], "application/json"
        )
        if isinstance(account_uuid, Response):
            return account_uuid
        ...
        if request.method in ("GET", "HEAD"):
            try:
                ...
                response = self.response(json.dumps({"message": "This dataset cannot be found."}))
                response.status_code = 404
                return response
        ...
        if request.method == "PUT":
            ...
            try:
                ...
                if dataset is None:
                    return self.error_403(
                        request,
                        (f"account{account_uuid} attempted to modify dataset:{dataset_id}."),
                    )
                ...
                result = self.db.update_dataset(
                    dataset["uuid"],
                    account_uuid,
                    title=validator.string_value(record, "title", 3, 1000),
                    description=validator.string_value(
                        record, "description", 0, 10000, strip_html=False
                    ),
                    ...
                    is_metadata_record=validator.boolean_value(
                        record, "is_metadata_record", when_none=False
                    ),
                    metadata_reason=validator.string_value(
                        record, "metadata_reason", 0, 512, strip_html=False
                    ),
                    embargo_until_date=validator.date_value(
                        record, "embargo_until_date", is_temporary_embargo
                    ),
                    embargo_type=validator.options_value(
                        record, "embargo_type", validator.embargo_types
                    ),
                    embargo_title=validator.string_value(record, "embargo_title", 0, 1000),
                    embargo_reason=validator.string_value(
                        record, "embargo_reason", 0, 10000, strip_html=False
                    ),
                    eula=validator.string_value(record, "eula", 0, 50000, strip_html=False),
                    defined_type_name=defined_type_name,
                    defined_type=defined_type,
                    git_repository_name=validator.string_value(
                        record, "git_repository_name", 0, 255
                    ),
                    git_code_hosting_url=validator.string_value(
                        record, "git_code_hosting_url", 0, 512
                    ),
                    agreed_to_deposit_agreement=validator.boolean_value(
                        record, "agreed_to_deposit_agreement", False, False
                    ),
                    agreed_to_publish=validator.boolean_value(
                        record, "agreed_to_publish", False, False
                    ),
                    authors=authors,
                    categories=categories,
                    references=references,
                    ...
                    requested_codecheck=validator.boolean_value(
                        record, "requested_codecheck", False, False
                    ),
                    codecheck_certificate_doi=validator.string_value(
                        record, "codecheck_certificate_doi", 0, 255
                    ),
                )

                if self.__is_reviewing(request):
                    try:
                        reviewer_account = self.db.account_by_session_token(
                            self.__impersonator_token(request)
                        )
                        review = self.db.reviews(dataset_uri=dataset["uri"])[0]
    ...
    def __api_private_item_authors(self, request, item_type, item_id, item_by_id_procedure):
        ...
        if request.method in ("GET", "HEAD"):
            try:
                item = item_by_id_procedure(item_id, account_uuid=account_uuid, is_published=False)
        ...
        if request.method in ("POST", "PUT"):
            ...
            try:
                ...
                new_authors, errors = self.__author_list_from_request_input(
                ...
                if request.method == "POST":
                    ...
                    existing_authors = list(
                        map(
                            lambda item: URIRef(uuid_to_uri(item["uuid"], "author")),
                            existing_authors,
                        )
                    )

                authors = existing_authors + new_authors
                if not self.db.update_item_list(item["uuid"], account_uuid, authors, "authors"):
    ...
    def api_private_dataset_authors(self, request, dataset_id):
        ...
        return self.__api_private_item_authors(
            request, "dataset", dataset_id, self.__dataset_by_id_or_uri
        )
    ...
    def api_private_dataset_author_delete(self, request, dataset_id, author_id):
        ...
        try:
            ...
            if dataset is None:
                return self.error_403(
                    request,
                    (f"account:{account_uuid} attempted to remove author on dataset:{dataset_id}."),
                )
    ...
    def __api_private_item_funding(self, request, item_id, item_type, item_by_id_procedure):
        ...
        if request.method in ("POST", "PUT"):
            ...
            try:
                ...
                new_fundings, errors = self.__funding_list_from_request_input(
                    parameters, account_uuid
                )
                if errors:
                    return self.error_400_list(request, errors)
                ...
                if request.method == "POST":
                    ...
                    existing_fundings = list(
                        map(
                            lambda item: URIRef(uuid_to_uri(item["uuid"], "funding")),
                            existing_fundings,
                        )
                    )

                fundings = existing_fundings + new_fundings
                if not self.db.update_item_list(
                    item["uuid"], account_uuid, fundings, "funding_list"
                ):
    ...
    def api_private_dataset_funding(self, request, dataset_id):
        ...
        return self.__api_private_item_funding(
            request, dataset_id, "dataset", self.__dataset_by_id_or_uri
        )

    def api_private_collection_funding(self, request, collection_id):
        """Implements /v2/account/collections/<id>/funding."""
        return self.__api_private_item_funding(
            request, collection_id, "collection", self.__collection_by_id_or_uri
        )

    def __api_private_item_funding_delete(
        self, request, item_id, item_type, item_by_id_procedure, funding_id
    ):
        ...
        try:
            ...
            fundings = list(
                map(lambda item: URIRef(uuid_to_uri(item["uuid"], "funding")), fundings)
            )
            if self.db.update_item_list(item["uuid"], account_uuid, fundings, "funding_list"):
                return self.respond_204()
    ...
    def api_private_dataset_funding_delete(self, request, dataset_id, funding_id):
        ...
        return self.__api_private_item_funding_delete(
            request, dataset_id, "dataset", self.__dataset_by_id_or_uri, funding_id
        )
    ...
    def api_private_collection_funding_delete(self, request, collection_id, funding_id):
        ...
        return self.__api_private_item_funding_delete(
            request, collection_id, "collection", self.__collection_by_id_or_uri, funding_id
        )
    ...
    def api_private_collection_author_delete(self, request, collection_id, author_id):
        ...
        try:
            ...
            if self.db.update_item_list(collection["uuid"], account_uuid, authors, "authors"):
                return self.respond_204()
    ...
    def api_private_collection_dataset_delete(self, request, collection_id, dataset_id):
        ...
        try:
            ...
            if self.db.delete_item_from_list(
                collection["uri"], "datasets", dataset["container_uri"]
            ):
                self.db.cache.invalidate_by_prefix("datasets")
                return self.respond_204()

            self.log.error(
                "Failed to delete dataset %s from collection %s.", dataset_id, collection_id
            )
        except (IndexError, KeyError) as error:
        ...
        return self.error_403(
            request,
            (
                f"account:{account_uuid} attempted to remove remove "
                f"dataset:{dataset_id} from collection:{collection_id}"
            ),
        )

    def __api_private_item_categories(self, request, item_type, item_id, item_by_id_procedure):
        ...
        if request.method in ("PUT", "POST"):
            try:
                ...
                if categories is None:
                    return self.error_400(
                        request, "Missing 'categories' parameter.", "MissingRequiredField"
                    )
                ...
                if request.method == "POST":
                    existing_categories = self.db.categories(
                        item_uri=item["uri"],
                        account_uuid=account_uuid,
                        is_published=False,
                        limit=None,
                    ...
                    existing_categories = list(
                        map(lambda category: category["uuid"], existing_categories)
                    )
                ...
                if self.db.update_item_list(item["uuid"], account_uuid, categories, "categories"):
                    return self.respond_205()
                ...
                return self.error_400(
                    request, "Expected an array for 'categories'.", "NoCategoriesField"
                )
            except validator.ValidationException as error:
                return self.error_400(request, error.message, error.code)
    ...
    def api_private_dataset_categories(self, request, dataset_id):
        ...
        return self.__api_private_item_categories(
            request, "dataset", dataset_id, self.__dataset_by_id_or_uri
        )

    def __api_private_delete_item_category(
        self, request, item_type, item_id, category_id, item_by_id_procedure
    ):
        ...
        try:
            ...
            if self.db.delete_item_from_list(
                item["uri"], "categories", uuid_to_uri(category["uuid"], "category")
            ):
                return self.respond_204()

            self.log.error(
                "Failed to delete category %s from %s %s.", category_id, item_type, item_id
            )
    ...
    def api_private_delete_dataset_category(self, request, dataset_id, category_id):
        ...
        return self.__api_private_delete_item_category(
            request, "dataset", dataset_id, category_id, self.__dataset_by_id_or_uri
        )
    ...
    def api_private_dataset_embargo(self, request, dataset_id):
        ...
        account_uuid = self.default_authenticated_error_handling(
            request, ["GET", "DELETE"], "application/json"
        )
        if isinstance(account_uuid, Response):
            return account_uuid
        ...
        if request.method == "DELETE":
            try:
                ...
                if self.db.delete_dataset_embargo(
                    dataset_uri=dataset["uri"], account_uuid=account_uuid
                ):
                    return self.respond_204()
            except (IndexError, KeyError):
    ...
    def api_private_dataset_files(self, request, dataset_id):
        ...
        account_uuid = self.default_authenticated_error_handling(
            request, ["GET", "POST", "DELETE"], "application/json"
        )
        if isinstance(account_uuid, Response):
            return account_uuid
        ...
        if request.method == "DELETE":
            ...
            try:
                ...
                if yesno is False:
                    self.log.error(
                        "Failed to delete all files from dataset %s due to a missing parameter.",
                        dataset_id,
                    )
                ...
                self.log.error("Failed to delete all files from dataset %s.", dataset_id)
        ...
        if request.method == "POST":
            ...
            try:
                ...
                if dataset is None:
                    return self.error_403(
                        request,
                        (f"account:{account_uuid} attempted to add link to dataset:{dataset_id}."),
                    )
    ...
    def api_private_dataset_file_details(self, request, dataset_id, file_id):
        ...
        if request.method in ("GET", "HEAD"):
            try:
                ...
                metadata = self.__file_by_id_or_uri(
                    file_id, account_uuid=account_uuid, dataset_uri=dataset["uri"]
                )
        ...
        if request.method == "DELETE":
            try:
                ...
                if dataset is None:
                    return self.error_403(
                        request,
                        (f"account:{account_uuid} attempted to remove dataset:{dataset_id}."),
                    )
                ...
                if self.db.delete_item_from_list(
                    dataset["uri"], "files", uuid_to_uri(metadata["uuid"], "file")
                ):
                    self.db.cache.invalidate_by_prefix(f"{account_uuid}_storage")
                    self.db.cache.invalidate_by_prefix(f"{dataset['uuid']}_dataset_storage")
                    return self.respond_204()

                self.log.error("Failed to delete file %s from dataset %s.", file_id, dataset_id)
    ...
    def api_private_dataset_private_links(self, request, dataset_id):
        ...
        if request.method in ("GET", "HEAD"):
            ...
            if value_or(dataset, "is_shared_with_me", False):
                return self.error_403(
                    request,
                    (
                        f"collaborator account:{account_uuid} attempted "
        ...
        if request.method == "POST":
            ...
            try:
                dataset = self.__dataset_by_id_or_uri(
                    dataset_id, is_published=False, account_uuid=account_uuid
                )
                if dataset is None:
                    return self.error_404(request)
                ...
                if value_or(dataset, "is_shared_with_me", False):
                    return self.error_403(
                        request,
                        (
                            f"collaborator account:{account_uuid} "
                ...
                if link_uri is None:
                    return self.error_500((f"Creating a private link failed for {dataset['uuid']}"))
                ...
                if not self.db.update_item_list(
                    dataset["uuid"], account_uuid, links, "private_links"
                ):
                    return self.error_500(
                        (f"Updating private links failed for {dataset['container_uuid']}.")
                    )

                return self.response(
                    json.dumps({"location": f"{config.base_url}/private_datasets/{id_string}"})
                )
    ...
    def api_private_dataset_private_links_details(self, request, dataset_id, link_id):
        ...
        if request.method in ("GET", "HEAD"):
            ...
            links = self.db.private_links(
                item_uri=dataset["uri"], id_string=link_id, account_uuid=account_uuid
            )
        ...
        if request.method == "PUT":
            ...
            try:
                ...
                return self.response(
                    json.dumps({"location": f"{config.base_url}/private_datasets/{link_id}"})
                )
        ...
        if request.method == "DELETE":
            ...
            result = self.db.delete_private_links(dataset["container_uuid"], account_uuid, link_id)
    ...
    def __datacite_reserve_doi(self, doi=None):
        ...
        try:
            ...
            if response.status_code in (201, 422):  # 422:already reserved
                ...
                self.log.error(
                    "DataCite responded with %s (%s)", response.status_code, response.text
                )
            return data
        except requests.exceptions.ConnectionError:
    ...
    def api_private_collection_reserve_doi(self, request, collection_id):
        ...
        if collection is None:
            return self.error_403(
                request,
                (
                    f"account:{account_uuid} attempted to reserve "
        ...
        if self.db.update_collection(collection["uuid"], account_uuid, doi=reserved_doi):
            return self.response(json.dumps({"doi": reserved_doi}))

        return self.error_500(
            (f"Updating the collection {collection_id} for reserving DOI {reserved_doi} failed.")
        )

    def __reserve_and_save_doi(self, account_uuid, item, version=None, item_type="dataset"):
        """
        ...
        doi = self.__standard_doi(container_uuid, version, value_or_none(item, "container_doi"))
        ...
        try:
            ...
            more_parm = {doi_type: doi, "is_first_online": not "timeline_first_online" in item}
    ...
    def api_private_dataset_reserve_doi(self, request, dataset_id):
        ...
        if dataset is None:
            return self.error_403(
                request,
                (f"account:{account_uuid} attempted to reserve DOI for dataset:{dataset_id}."),
            )
    ...
    def __update_item_doi(self, item_id, version=None, item_type="dataset", from_draft=True):
        ...
        parameters = self.__metadata_export_parameters(
            item_id, version, item_type=item_type, from_draft=from_draft
        )
        xml = str(xml_formatter.datacite(parameters, indent=False), encoding="utf-8")
        xml = (
            '<?xml version="1.0" encoding="UTF-8"?>' + xml.split("?>", 1)[1]
        )  # Datacite is very choosy about this
        doi = parameters["doi"]
        ...
        try:
            ...
            self.log.error("DataCite responded with %s (%s)", response.status_code, response.text)
        except requests.exceptions.ConnectionError:
    ...
    def api_private_datasets_search(self, request):
        ...
        try:
            ...
            records = self.db.datasets(
                ...
                search_for=validator.string_value(
                    parameters, "search_for", 0, 512, strip_html=False
                ),
                limit=limit,
                offset=offset,
    ...
    def __default_collection_api_parameters(self, request):
        ...
        record = {
            "order": validator.string_value(
                self.get_parameter(request, "order"), None, maximum_length=32, error_list=errors
            ),
            "order_direction": validator.order_direction(
                self.get_parameter(request, "order_direction"), None, error_list=errors
            ),
            "institution": validator.integer_value(
                self.get_parameter(request, "institution"), None, error_list=errors
            ),
            "published_since": validator.string_value(
                self.get_parameter(request, "published_since"),
                None,
                maximum_length=32,
                error_list=errors,
            ),
            "modified_since": validator.string_value(
                self.get_parameter(request, "modified_since"),
                None,
                maximum_length=32,
                error_list=errors,
            ),
            "group": validator.integer_value(
                self.get_parameter(request, "group"), None, error_list=errors
            ),
            "resource_doi": validator.string_value(
                self.get_parameter(request, "resource_doi"),
                None,
                maximum_length=255,
                error_list=errors,
            ),
            "doi": validator.string_value(
                self.get_parameter(request, "doi"), None, maximum_length=255, error_list=errors
            ),
            "handle": validator.string_value(
                self.get_parameter(request, "handle"), None, maximum_length=255, error_list=errors
            ),
            "is_latest": True,
        }
    ...
    def api_collections(self, request):
        ...
        return self.default_list_response(
            records, formatter.format_collection_record, base_url=config.base_url
        )
    ...
    def api_collection_versions(self, request, collection_id):
        ...
        return self.default_list_response(
            versions, formatter.format_collection_version_record, base_url=config.base_url
        )
        ...
        if request.method == "POST":
            ...
            try:
                ...
                collection_id, _ = self.db.insert_collection(
                    ...
                    categories_by_source_id=validator.array_value(
                        record, "categories_by_source_id", False
                    ),
                    tags=validator.array_value(record, "tags", False),
                    ...
                    resource_version=validator.integer_value(
                        record, "resource_version", 0, pow(2, 63), False
                    ),
                    group_id=validator.integer_value(record, "group_id", 0, pow(2, 63), False),
                    # Unpack the 'timeline' object.
                    publisher_publication=validator.string_value(
    ...
    def api_private_collection_details(self, request, collection_id):
        ...
        if request.method in ("GET", "HEAD"):
            try:
                ...
                if collection is None:
                    return self.error_403(
                        request,
                        (f"account:{account_uuid} attempted to view collection:{collection_id}."),
                    )
                ...
                response = self.response(
                    json.dumps({"message": "This collection cannot be found."})
                )
                response.status_code = 404
                return response
        ...
        if request.method == "PUT":
            ...
            try:
                ...
                result = self.db.update_collection(
                    collection["uuid"],
                    account_uuid,
                    title=validator.string_value(record, "title", 3, 1000),
                    description=validator.string_value(
    ...
    def api_private_collections_search(self, request):
        ...
        parameters = {
            "resource_doi": validator.string_value(
                record, "resource_doi", 0, 255, error_list=errors
            ),
            ...
            "search_for": validator.string_value(
                record, "search_for", maximum_length=1024, strip_html=False, error_list=errors
            ),
            "order_direction": validator.order_direction(
                record, "order_direction", error_list=errors
            ),
            "institution": validator.integer_value(record, "institution", error_list=errors),
            "published_since": validator.string_value(
                record, "published_since", 0, 255, error_list=errors
            ),
            "modified_since": validator.string_value(
                record, "modified_since", 0, 255, error_list=errors
            ),
    ...
    def api_private_collection_authors(self, request, collection_id):
        ...
        return self.__api_private_item_authors(
            request, "collection", collection_id, self.__collection_by_id_or_uri
        )
    ...
    def api_private_delete_collection_category(self, request, collection_id, category_id):
        ...
        return self.__api_private_delete_item_category(
            request, "collection", collection_id, category_id, self.__collection_by_id_or_uri
        )
    ...
    def api_private_collection_datasets(self, request, collection_id):
        ...
        if request.method in ("GET", "HEAD"):
            try:
                ...
                offset, limit = self.__paging_offset_and_limit(request)
                datasets = self.db.datasets(
                    collection_uri=collection["uri"], is_latest=True, limit=limit, offset=offset
                )

                return self.default_list_response(
                    datasets, formatter.format_dataset_record, base_url=config.base_url
                )
            except (IndexError, KeyError):
                pass
            except validator.ValidationException as error:
        ...
        if request.method in ("PUT", "POST"):
            try:
                ...
                existing_datasets = []
                if request.method == "POST":
                    existing_datasets = self.db.datasets(
                        collection_uri=collection["uri"], is_latest=True, limit=10000
                    )
                    if existing_datasets:
                        existing_datasets = list(
                            map(lambda item: item["container_uuid"], existing_datasets)
                        )
                ...
                for index, _ in enumerate(datasets):
                    ...
                    dataset = self.__dataset_by_id_or_uri(
                        dataset, is_latest=True, is_published=True
                    )
                    if dataset is None:
                        return self.error_500()
                ...
                if self.db.update_item_list(collection["uuid"], account_uuid, datasets, "datasets"):
                    self.db.cache.invalidate_by_prefix("datasets")
                    return self.respond_205()
                ...
                return self.error_400(
                    request, "Expected an array for 'articles'.", "NoArticlesField"
                )
            except validator.ValidationException as error:
                return self.error_400(request, error.message, error.code)
    ...
    def api_collection_datasets(self, request, collection_id):
        ...
        try:
            ...
            offset, limit = self.__paging_offset_and_limit(request)
            datasets = self.db.datasets(
                collection_uri=collection["uri"], limit=limit, offset=offset, is_latest=True
            )
            return self.default_list_response(
                datasets, formatter.format_dataset_record, base_url=config.base_url
            )
    ...
    def api_v3_datasets(self, request):
        ...
        record = {
            "categories": validator.string_value(
                self.get_parameter(request, "categories"),
                None,
                maximum_length=512,
                error_list=errors,
            ),
            ...
            "groups": validator.string_value(
                self.get_parameter(request, "group_ids"),
                None,
                maximum_length=512,
                error_list=errors,
            ),
            ...
            "item_type": validator.integer_value(
                self.get_parameter(request, "item_type"), None, error_list=errors
            ),
            "limit": validator.integer_value(
                self.get_parameter(request, "limit"), None, error_list=errors
            ),
            "modified_since": validator.string_value(
                self.get_parameter(request, "modified_since"),
                None,
            ...
            "offset": validator.integer_value(
                self.get_parameter(request, "offset"), None, error_list=errors
            ),
            "order": validator.string_value(
                self.get_parameter(request, "order"), None, maximum_length=32, error_list=errors
            ),
            ...
            "return_count": validator.boolean_value(
                self.get_parameter(request, "return_count"), None, error_list=errors
            ),
        }
        ...
        if record["categories"] is not None:
            for index, _ in enumerate(record["categories"]):
                record["categories"][index] = validator.integer_value(
                    record["categories"], index, error_list=errors
                )

        record["groups"] = split_string(record["groups"], delimiter=",")
        if record["groups"] is not None:
            for index, _ in enumerate(record["groups"]):
                record["groups"][index] = validator.integer_value(
                    record["groups"], index, error_list=errors
                )
    ...
    def api_v3_author_details(self, request, author_uuid):
        ...
        account_uuid = self.default_authenticated_error_handling(
            request, ["GET", "PUT"], "application/json"
        )
        if isinstance(account_uuid, Response):
            return account_uuid
    ...
    def __reorder_authors_for_item(self, request, container_uuid):
        ...
        direction = validator.options_value(
            parameters, "direction", ["up", "down"], required=True, error_list=errors
        )
        author_uuid = validator.string_value(parameters, "author", required=True, error_list=errors)
        if not validator.is_valid_uuid(author_uuid):
    ...
    def api_v3_codemeta(self, request):
        ...
        try:
            ...
            offset, limit = self.__paging_offset_and_limit(request, error_list=errors)
            modified_since = validator.string_value(
                request.args, "modified_since", 0, 32, False, error_list=errors
            )
            order = validator.string_value(request.args, "order", 0, 255, False, error_list=errors)
            order_direction = validator.order_direction(
                request.args, "order_direction", False, error_list=errors
            )
    ...
    def api_v3_datasets_search(self, request):
        ...
        try:
            record = {
                ...
                "modified_since": validator.string_value(
                    parameters, "modified_since", maximum_length=32
                ),
                "order": validator.string_value(parameters, "order", 0, 32),
                "order_direction": validator.order_direction(parameters, "order_direction"),
                "organizations": validator.string_value(
                    parameters, "organizations", maximum_length=255
                ),
                "published_since": validator.string_value(
                    parameters, "published_since", maximum_length=32
                ),
                "resource_doi": validator.string_value(
                    parameters, "resource_doi", maximum_length=255
                ),
                "search_for": validator.string_value(
                    parameters, "search_for", maximum_length=1024, strip_html=False
                ),
            ...
            if record["search_format"] is not None:
                record["search_format"] = validator.search_filters(
                    {"format": record["search_format"]}
                )
            ...
            if record["licenses"] is not None:
                ...
                for index, _ in enumerate(record["licenses"]):
                    record["licenses"][index] = validator.string_value(
                        record["licenses"], index, maximum_length=255
                    )
    ...
    def __api_v3_datasets_parameters(self, request, item_type):
        record = {
            ...
            "group_ids": validator.string_value(
                self.get_parameter(request, "group_ids"), None, maximum_length=512
            ),
        }
    ...
    def __git_repository_default_branch_guess(self, git_repository):
        ...
        try:
            ...
            self.log.error(
                "Failed to resolve git repository HEAD for '%s': %s", git_repository.path, error
            )
            head_reference = None
        except KeyError as error:
            self.log.error(
                "HEAD points to non-existing branch for '%s': %s", git_repository.path, error
            )
            head_reference = None
    ...
    def __git_set_default_branch(self, git_repository, branch_name):
        ...
        try:
            ...
            self.log.info("Set default branch to '%s' for %s.", branch_name, git_repository.path)
            return True
        # It seems the way pygit2 loads internally trips up pylint.
        except pygit2.GitError as error:  # pylint: disable=no-member
            self.log.error(
                "Failed to set default branch to '%s' for '%s' due to: '%s'.",
                branch_name,
                git_repository.path,
                error,
            )
    ...
    def api_v3_dataset_git_branches(self, request, dataset_id):
        ...
        return self.response(json.dumps({"default-branch": default_branch, "branches": branches}))
    ...
    def api_v3_dataset_git_files(self, request, dataset_id):
        ...
        if branch_name:
            try:
                ...
                return self.error_500(
                    (
                        "Failed to retrieve Git files for branch "
    ...
    def __git_files_for_zipfly(self, filesystem_path, tree, path=""):
        ...
        for entry in tree:
            ...
            if isinstance(entry, pygit2.Tree):  # pylint: disable=no-member
                file_paths += self.__git_files_for_zipfly(
                    filesystem_path, list(entry), f"{path}{entry.name}/"
                )
                continue
    ...
    def api_v3_dataset_git_zip(self, request, git_uuid):
        ...
        with tempfile.TemporaryDirectory(
            dir=self.db.cache.storage, prefix="git-zip-", delete=False
        ) as folder:
    ...
    def api_v3_dataset_decline(self, request, dataset_id):
        ...
        if may_review_institution:
            if value_or(dataset, "group_id", "A") != value_or(
                reviewer_account, "group_id", "not-A"
            ):
                return self.error_403(request)
        ...
        if self.db.decline_dataset(container_uuid, account_uuid):
            try:
                ...
                self.__send_templated_email(
                    [account["email"]], subject, "dataset_declined", **parameters
                )

                self.__send_email_to_reviewers(
                    subject,
            ...
            return self.respond_201({"location": f"{config.base_url}/review/overview"})
    ...
    def api_v3_dataset_publish(self, request, dataset_id):
        ...
        if config.in_production and not config.in_preproduction:
            for version in (None, new_version):
                reserved_doi = self.__reserve_and_save_doi(account_uuid, dataset, version=version)
                if not reserved_doi:
                    return self.error_500(
                        (f"Reserving DOI {reserved_doi} for {container_uuid} failed.")
                    )

                if not self.__update_item_doi(container_uuid, item_type="dataset", version=version):
                    return self.error_500(
                        (f"Updating DOI {reserved_doi} for publication of {container_uuid} failed.")
                    )
        ...
        if self.db.publish_dataset(container_uuid, account_uuid):
            try:
                ...
                if git_url is not None and git_uuid is not None:
                    ...
                    self.log.info(
                        "Caching Git repository '%s' languages status: %s",
                        dataset["git_uuid"],
                        response.status_code,
                    )
                    response = self.api_v3_dataset_git_contributors(request, git_uuid)
                    self.log.info(
                        "Caching Git repository '%s' contributors status: %s",
                        dataset["git_uuid"],
                        response.status_code,
                    )
                ...
                self.__send_templated_email(
                    [account["email"]], subject, "dataset_approved", **parameters
                )
    ...
    def api_v3_collection_publish(self, request, collection_id):
        ...
        authors = self.db.authors(item_uri=collection["uri"], item_type="collection")
        if not authors:
            errors.append(
                {
                    "field_name": "authors",
        ...
        tags = self.db.tags(item_uri=collection["uri"], account_uuid=account_uuid)
        if not tags:
            errors.append(
                {"field_name": "tag", "message": "The collection must have at least one keyword."}
            )

        categories = self.db.categories(
            item_uri=collection["uri"], account_uuid=account_uuid, is_published=False, limit=None
        )
        ...
        if config.in_production and not config.in_preproduction:
            for version in (None, new_version):
                reserved_doi = self.__reserve_and_save_doi(
                    account_uuid, collection, version=version, item_type="collection"
                )
                if not reserved_doi:
                    return self.error_500(
                        (f"Reserving DOI {reserved_doi} for {container_uuid} failed.")
                ...
                if not self.__update_item_doi(
                    container_uuid, version=version, item_type="collection"
                ):
                    return self.error_500(
                        (f"Updating DOI {reserved_doi} for publication of {container_uuid} failed.")
                    )
        ...
        if self.db.publish_collection(collection["container_uuid"], account_uuid):
            return self.respond_201({"location": f"{config.base_url}/published/{collection_id}"})
    ...
    def api_v3_dataset_submit(self, request, dataset_id):
        ...
        dataset = self.__dataset_by_id_or_uri(
            dataset_id, account_uuid=account_uuid, is_published=False, is_under_review=False
        )
        ...
        try:
            ...
            is_temporary_embargo = is_embargoed and not is_restricted and not is_closed
            agreed_to_deposit_agreement = validator.boolean_value(
                record, "agreed_to_deposit_agreement", True, False, errors
            )
            agreed_to_publish = validator.boolean_value(
            ...
            authors = self.db.authors(item_uri=dataset["uri"], item_type="dataset")
            if not authors:
                errors.append(
                    {
                        "field_name": "authors",
            ...
            tags = self.db.tags(item_uri=dataset["uri"], account_uuid=account_uuid)
            if not tags:
                errors.append(
                    {"field_name": "tag", "message": "The dataset must have at least one keyword."}
                )

            categories = self.db.categories(
                item_uri=dataset["uri"], account_uuid=account_uuid, is_published=False, limit=None
            )
            ...
            resource_doi = normalize_doi(
                validator.string_value(record, "resource_doi", 0, 255, False)
            )
            if not validator.is_valid_doi(resource_doi):
                errors.append(
                    {"field_name": "resource_doi", "message": "Please enter a valid DOI."}
                )

            codecheck_certificate_doi = normalize_doi(
                validator.string_value(record, "codecheck_certificate_doi", 0, 255, False)
            )
            ...
            parameters = {
                ...
                "description": validator.string_value(
                    record, "description", 0, 10000, True, errors, strip_html=False
                ),
                "resource_doi": resource_doi,
                "resource_title": validator.string_value(
                    record, "resource_title", 0, 255, False, errors
                ),
                "license_url": license_url,
                "group_id": validator.integer_value(
                    record, "group_id", 0, pow(2, 63), True, errors
                ),
                "time_coverage": validator.string_value(
                    record, "time_coverage", 0, 512, False, errors
                ),
                ...
                "contributors": validator.string_value(
                    record, "contributors", 0, 10000, False, errors
                ),
                "license_remarks": validator.string_value(
                    record, "license_remarks", 0, 10000, False, errors
                ),
                ...
                "derived_from": validator.string_value(
                    record, "derived_from", 0, 255, False, errors
                ),
                "same_as": validator.string_value(record, "same_as", 0, 255, False, errors),
                "organizations": validator.string_value(
                    record, "organizations", 0, 2048, False, errors
                ),
                "is_embargoed": is_embargoed,
                "is_restricted": is_restricted,
                "is_metadata_record": validator.boolean_value(
                ...
                "embargo_until_date": validator.date_value(
                    record, "embargo_until_date", is_temporary_embargo, errors
                ),
                "embargo_type": validator.options_value(
                    record, "embargo_type", validator.embargo_types, is_temporary_embargo, errors
                ),
                "embargo_title": validator.string_value(
                    record, "embargo_title", 0, 1000, is_embargoed, errors
                ),
                "embargo_reason": validator.string_value(
                    record, "embargo_reason", 0, 10000, is_embargoed, errors, strip_html=False
                ),
                "eula": validator.string_value(
                    record, "eula", 0, 50000, is_restricted, errors, strip_html=False
                ),
            ...
            if not parameters["is_metadata_record"]:
                files = self.db.dataset_files(
                    account_uuid=account_uuid, dataset_uri=dataset["uri"], limit=1
                )
    ...
    def api_v3_profile_picture(self, request):
        ...
        if request.method == "DELETE":
            try:
                ...
                self.log.error(
                    "Failed to remove profile image for %s due to: %s", account["uuid"], error
                )
        ...
        if request.method == "POST":
            ...
            try:
                ...
                if not (extension.lower() == ".jpg" or extension.lower() == ".png"):
                    return self.error_400(
                        request, "Only JPG and PNG images are supported.", "InvalidImageFormat"
                    )
                ...
                if self.db.update_account(account["uuid"], profile_image=output_filename):
                    ...
                    return self.response(
                        json.dumps({"location": f"{config.base_url}/v3/profile/picture"})
                    )
                ...
                return self.error_400(
                    request, "Uploading the profile image failed.", "UploadFailed"
                )
    ...
    def __register_file_handle(self, handle, download_url):
        ...
        try:
            ...
            self.log.error(
                "Handle registration failed with %s (%s)", response.status_code, response.text
            )
    ...
    def api_v3_dataset_upload_file(self, request, dataset_id):
        ...
        if strict_check:
            try:
                supplied_md5 = validator.string_value(
                    request.args, "md5", minimum_length=32, maximum_length=32, required=True
                )
            except validator.ValidationException as error:
                return self.error_400(request, error.message, error.code)
        ...
        try:
            ...
            if strict_check:
                files = self.db.dataset_files(dataset_uri=dataset["uri"], account_uuid=account_uuid)
            ...
            try:
                ...
                return self.error_400(
                    request, "Missing boundary for multipart/form-data.", "MissingBoundary"
                )
            ...
            if bytes_to_read is None:
                ...
                return self.error_400(
                    request, "Missing Content-Length header.", "MissingContentLength"
                )
            ...
            if storage_available < bytes_to_read:
                self.log.error(
                    "File upload failed because user's quota limit: quota(%d), used(%d), available(%s), filesize(%d)",
                    account["quota"],
                    storage_used,
                    storage_available,
                    bytes_to_read,
            ...
            if not boundary_scan == expected_begin:
                ...
                return self.error_400(
                    request, "Expected stream to start with boundary.", "MalformedRequest"
                )
            ...
            if "Content-Disposition: form-data" not in part_headers:
                ...
                return self.error_400(
                    request, "Expected Content-Disposition: form-data", "MalformedRequest"
                )
            ...
            computed_file_size = (
                request.content_length - read_ahead_bytes - headers_len - len(expected_end)
            )
            ...
            try:
                ...
                self.error_500((f"Failed to create file metadata for {dataset_id}: {error}."))
            ...
            try:
                ...
                is_incomplete = 1
                self.log.error(
                    "Failed to write %s to disk: possible that bad internet connection on user's side or page refreshed/closed during upload.",
                    output_filename,
                )
            ...
            if computed_file_size != file_size:
                is_incomplete = 1
                self.log.error(
                    "Computed file size (%d) and actual file size (%d) for uploaded file mismatch.",
                    computed_file_size,
                    file_size,
                )
            ...
            if bytes_to_read != len(expected_end):
                is_incomplete = 1
                self.log.error(
                    "Expected different length after file contents: '%d' != '%d'.",
                    bytes_to_read,
                    len(expected_end),
                )
            ...
            if is_incomplete != 1:
                ...
                if ending != expected_end:
                    is_incomplete = 1
                    self.log.error(
                        "Expected different end after file contents: '%s' != '%s'.",
                        ending,
                        expected_end,
                    )
            ...
            if strict_check and computed_md5 != supplied_md5:
                self.log.error(
                    "MD5 checksum mismatch for %s: computed_md5(%s) != supplied_md5(%s)",
                    output_filename,
                    computed_md5,
                    supplied_md5,
                )
                ...
                try:
                    file_metadata = self.__file_by_id_or_uri(
                        file_uuid, account_uuid=account_uuid, dataset_uri=dataset["uri"]
                    )

                    if self.db.delete_item_from_list(
                        dataset["uri"], "files", uuid_to_uri(file_metadata["uuid"], "file")
                    ):
                        self.db.cache.invalidate_by_prefix(f"{account_uuid}_storage")
                        self.db.cache.invalidate_by_prefix(f"{dataset['uuid']}_dataset_storage")
                    else:
                        self.log.error(
                            "Failed to delete file %s from dataset %s.", file_uuid, dataset_id
                        )
                except (IndexError, KeyError, StopIteration):
                    pass

                os.remove(output_filename)
                return self.error_400(request, "MD5 checksum mismatch.", "MD5Mismatch")
        ...
        try:
            ...
            if dataset is None:
                return self.error_403(
                    request,
                    (
                        f"account:{account_uuid} attempted to view "
    ...
    def api_v3_datasets_update_thumbnail(self, request, dataset_id):
        ...
        if dataset is None:
            return self.error_403(
                request,
                (
                    f"account:{account_uuid} attempted to update "
        ...
        try:
            ...
            if file_uuid == "":
                if not self.db.dataset_update_thumb(dataset["uuid"], account_uuid, file_uuid, None):
                    return self.error_500()
                return self.respond_205()
        ...
        if not self.db.dataset_update_thumb(dataset["uuid"], account_uuid, file_uuid, extension):
            return self.error_500()
    ...
    def __api_v3_item_references(self, request, item):
        ...
        try:
            references = self.db.references(item_uri=item["uri"], account_uuid=account_uuid)
            ...
            if request.method == "DELETE":
                ...
                if not self.db.update_item_list(
                    item["uuid"], account_uuid, references, "references"
                ):
            ...
            if not self.db.update_item_list(item["uuid"], account_uuid, references, "references"):
    ...
    def __api_v3_item_tags(self, request, item_type, item_id, item_by_id_procedure):
        ...
        try:
            ...
            if request.method == "POST":
                existing_tags = self.db.tags(
                    item_uri=item["uri"], account_uuid=account_uuid, limit=10000
                )
    ...
    def api_v3_collection_tags(self, request, collection_id):
        ...
        return self.__api_v3_item_tags(
            request, "collection", collection_id, self.__collection_by_id_or_uri
        )
    ...
    def api_v3_admin_files_integrity_statistics(self, request):
        ...
        handler = self.default_authenticated_error_handling(
            request, "GET", "application/json", self.db.may_review_integrity
        )
        if isinstance(handler, Response):
            return handler
        ...
        for entry in files:
            ...
            if not (
                (isinstance(filesystem_location, str) and os.path.isfile(filesystem_location))
                or available_on_s3
            ):
    ...
    def __git_create_repository(self, git_uuid):
        ...
        if not os.path.exists(git_directory):
            ...
            if initial_repository:
                try:
                    with open(
                        os.path.join(git_directory, "config"), "a", encoding="utf-8"
                    ) as git_config:
                        git_config.write("\n[http]\n  receivepack = true\n")
                except FileNotFoundError:
    ...
    def api_v3_private_dataset_git_instructions(self, request, git_uuid):
        ...
        try:
            ...
            dataset = self.db.datasets(git_uuid=git_uuid, is_published=True, is_latest=None)[0]
            git_repository_url = self.__git_repository_url_for_dataset(dataset)
            return self.__render_template(
                request, "git_instructions.html", git_repository_url=git_repository_url
            )
        except IndexError:
            pass
    ...
    def api_v3_private_dataset_git_receive_pack(self, request, git_uuid):
        ...
        try:
            if not validator.is_valid_uuid(git_uuid):
                return self.error_403(
                    request, ("Someone attempted to update a git repository with an invalid UUID.")
                )
        ...
        return self.error_403(
            request, (f"Someone attempted to update the git repository git:{git_uuid}.")
        )
    ...
    def api_v3_private_dataset_git_upload_pack(self, request, git_uuid):
        ...
        try:
            if not validator.is_valid_uuid(git_uuid):
                return self.error_403(
                    request, ("Someone attempted to pull a git repository with an invalid UUID.")
                )
            dataset = self.db.datasets(git_uuid=git_uuid, is_published=None, is_latest=None)[0]
            if dataset is not None:
        ...
        return self.error_403(
            request, (f"Someone attempted to pull the git repository git:{git_uuid}.")
        )
    ...
    def __git_contributors(self, git_uuid, git_repository):
        ...
        contributors[previous_commit.author.email] = {
            ...
            "author": {"name": previous_commit.author.name, "email": previous_commit.author.email},
        }
    ...
    def api_v3_datasets_assign_reviewer(self, request, dataset_uuid, reviewer_uuid):
        ...
        try:
            dataset = self.db.datasets(
                dataset_uuid=dataset_uuid, is_published=False, is_under_review=True
            )[0]
        except (IndexError, TypeError):
            pass
    ...
    def api_v3_doi_badge(self, request, dataset_id, version=None):
        ...
        try:
            ...
            return self.__render_svg_template(
                "badge.svg", doi=doi, version=version, color=config.colors["primary-color"]
            )
        except KeyError:
            pass
    ...
    def api_v3_receive_from_ssi(self, request):
        ...
        container_uuid, _ = self.db.insert_dataset(title=title, account_uuid=account_uuid)
        if container_uuid is None:
            return self.error_500(f"Failed to create dataset for account {account_uuid}.")

        response = redirect(
            f"{config.base_url}/v3/redirect-from-ssi/{container_uuid}/{token}", code=302
        )
        return response
    ...
    def __metadata_export_parameters(
        self, item_id, version=None, item_type="dataset", from_draft=False
    ):
        ...
        if from_draft:
            ...
            try:
                ...
                self.log.warning(
                    "Nothing found for %s %s version %s.", item_type, item_id, current_version
                )
        ...
        if not bool(doi):
            doi = self.__standard_doi(container_uuid, version, value_or_none(container, "doi"))
    ...
    def export_datacite(self, request, parameters, item_id, version_string):
        ...
        output.headers["Content-disposition"] = (
            f"attachment; filename={item_id}{version_string}_datacite.xml"
        )
        return output
    ...
    def export_refworks(self, request, parameters, item_id, version_string):
        ...
        output = self.response(xml_string, mimetype="application/xml")
        output.headers["Content-disposition"] = (
            f"attachment; filename={item_id}{version_string}_refworks.xml"
        )
        return output
    ...
    def export_nlm(self, request, parameters, item_id, version_string):
        ...
        output = self.response(xml_string, mimetype="application/xml")
        output.headers["Content-disposition"] = (
            f"attachment; filename={item_id}{version_string}_nlm.xml"
        )
        return output
    ...
    def export_dc(self, request, parameters, item_id, version_string):
        ...
        output = self.response(xml_string, mimetype="application/xml")
        output.headers["Content-disposition"] = (
            f"attachment; filename={item_id}{version_string}_dublincore.xml"
        )
        return output
    ...
    def export_bibtex(self, request, parameters, item_id, version_string):  # pylint: disable=unused-argument
        ...
        parameters["authors_str"] = " and ".join(
            [f"{author['last_name']}, {author['first_name']}" for author in parameters["authors"]]
        )
        parameters["tags_str"] = ", ".join(parameters["tags"])
        headers = {"Content-disposition": f"attachment; filename={item_id}{version_string}.bib"}
        return self.__render_export_format(
            template_name="bibtex.bib", mimetype="text/plain", headers=headers, **parameters
        )
    ...
    def export_refman(self, request, parameters, item_id, version_string):  # pylint: disable=unused-argument
        ...
        return self.__render_export_format(
            template_name="refman.ris", mimetype="text/plain", headers=headers, **parameters
        )
    ...
    def export_endnote(self, request, parameters, item_id, version_string):  # pylint: disable=unused-argument
        ...
        return self.__render_export_format(
            template_name="endnote.enw", mimetype="text/plain", headers=headers, **parameters
        )
    ...
    def export_cff(self, request, parameters, item_id, version_string):  # pylint: disable=unused-argument
        ...
        return self.__render_export_format(
            template_name="citation.cff", mimetype="text/plain", headers=headers, **parameters
        )
    ...
    def iiif_v3_image(self, request, file_uuid, region, size, rotation, quality, image_format):
        ...
        supported_formats = ["jpg", "png", "tif", "webp"]
        quality = validator.options_value(
            parameters, "quality", supported_qualities, required=True, error_list=validation_errors
        )

        image_format = validator.options_value(
            parameters,
            "image_format",
            supported_formats,
            required=True,
        ...
        if region == "square":
            ...
            validation_errors.append(
                {"field_name": "region", "message": "Percentage-wise regions are not implemented."}
            )

        # Attempt to parse the x,y,w,h format
        if validator.index_exists(region, 255):
            validation_errors.append({"field_name": "region", "message": "The region is too long"})
        elif region not in ("full", "square"):
            deconstructed = region.split(",")
            if len(deconstructed) != 4:
                validation_errors.append(
                    {"field_name": "region", "message": "The region format should be 'x,y,w,h'."}
                )
            else:
                output_region = {
                    "x": deconstructed[0],
        ...
        if size != "max" and "," not in size:
            validation_errors.append(
                {"field_name": "size", "message": f"Unexpected value '{size}' for size."}
            )
        ...
        if "," in size:
            ...
            if len(sizes) != 2:
                validation_errors.append(
                    {"field_name": "size", "message": "Expected a 'width,height' specification."}
                )

            elif sizes[0].startswith("^"):
                validation_errors.append(
                    {"field_name": "size", "message": "Image scaling is not supported."}
                )
                ...
                if scale_for_best_fit:
                    ...
                    if scale_factor < 1.0:
                        output_size = {
                            "w": int(original.width * scale_factor),
        ...
        try:
            ...
            validation_errors.append(
                {"field_name": "rotation", "message": "Rotation must be an integer."}
            )
        ...
        # Serve from cache
        # ---------------------------------------------------------------------
        cache_key = self.db.cache.make_key(
            (f"{file_uuid}_{region}_{size}_{mirror}_{rotation}_{quality}_{image_format}")
        )
        ...
        try:
            ...
            output = output.crop(
                output_region["x"], output_region["y"], output_region["w"], output_region["h"]
            )
            output = output.thumbnail_image(output_size["w"], height=output_size["h"], size="force")
            if mirror:
    ...
    def iiif_v3_presentation_manifest(self, request, container_uuid, version):
        ...
        if value_or(dataset, "is_restricted", False) or value_or(dataset, "is_embargoed", False):
            return self.error_403(
                request, ("Attempted to view a restricted dataset's IIIF manifest.")
            )
        ...
        if not iiif_files:
            return self.error_404(
                request, (f"No IIIF-enabled files for container:{container_uuid}.")
            )

        authors = self.db.authors(item_uri=dataset["uri"], item_type="dataset", limit=10000)
        record = formatter.format_iiif_manifest_record(
            dataset, iiif_files, authors, version, config.base_url
        )
